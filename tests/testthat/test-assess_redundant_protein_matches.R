test_that("assess_redundant_protein_matches works", {
  temp_dir <- tempdir()
  ...
  expect_true("redundantAccessions" %in% names(msnid))
  expect_equal(head(unique(msnid$redundantAccessions)),
               c("NP_001102567.1|XP_006251717.1",
                 "XP_017447817.1|XP_017456475.1",
                 "NP_445967.1|NP_476443.1|XP_008771999.1",
                 "NP_445749.1|XP_002727490.1|XP_003752000.1|XP_006243250.2",
                 "NP_596915.1",
                 "NP_001163796.1"))
